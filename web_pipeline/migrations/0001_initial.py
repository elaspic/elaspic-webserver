...
class Migration(migrations.Migration):
    ...
    replaces = [('web_pipeline', '0001_initial'), ('web_pipeline', '0002_auto_20160905_2052'), ('web_pipeline', '0003_coremutationlocal_elaspic_version'), ('web_pipeline', '0004_interfacemutationlocal_elaspic_version')]
    ...
    operations = [
        migrations.CreateModel(
            name='CoreModel',
            fields=[
                ('id', models.AutoField(db_column='domain_id', db_index=True, primary_key=True, serialize=False)),
                ...
                ('align_score', models.IntegerField(blank=True, db_column='alignment_score', null=True)),
                ('align_coverage', models.FloatField(blank=True, db_column='alignment_coverage', null=True)),
                ('template_errors', models.TextField(blank=True, db_column='template_errors', null=True)),
                ('domain_def', models.CharField(blank=True, max_length=255)),
                ('cath', models.CharField(blank=True, db_column='cath_id', max_length=255)),
                ('seq_id', models.FloatField(blank=True, db_column='alignment_identity', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mut_errors', models.TextField(blank=True, db_column='mutation_errors', null=True)),
                ('pdb_chain', models.CharField(db_column='chain_modeller', max_length=1, null=True)),
                ('pdb_mut', models.CharField(db_column='mutation_modeller', max_length=8, null=True)),
        ...
        migrations.CreateModel(
            name='HGNCIdentifier',
            fields=[
                ('identifierID', models.CharField(db_column='identifier_id', db_index=True, max_length=255, primary_key=True, serialize=False)),
                ('identifierType', models.CharField(db_column='identifier_type', db_index=True, max_length=20)),
                ('uniprotID', models.CharField(db_column='uniprot_id', db_index=True, max_length=10)),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='InterfaceModel',
            fields=[
                ('id', models.AutoField(db_column='interface_id', db_index=True, primary_key=True, serialize=False)),
                ('protein_id_1', models.CharField(max_length=15)),
                ('protein_id_2', models.CharField(max_length=15)),
                ('data_path', models.TextField(blank=True, db_column='path_to_data')),
                ('align_score1', models.IntegerField(blank=True, db_column='alignment_score_1', null=True)),
                ('align_score2', models.IntegerField(blank=True, db_column='alignment_score_2', null=True)),
                ('align_coverage_1', models.IntegerField(blank=True, db_column='alignment_coverage_1', null=True)),
                ('align_coverage_2', models.IntegerField(blank=True, db_column='alignment_coverage_2', null=True)),
                ...
                ('seq_id1', models.FloatField(blank=True, db_column='alignment_identity_1', null=True)),
                ('seq_id2', models.FloatField(blank=True, db_column='alignment_identity_2', null=True)),
        ...
        migrations.CreateModel(
            name='Protein',
            fields=[
                ('id', models.CharField(db_column='protein_id', max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifierID', models.CharField(db_column='identifier_id', db_index=True, max_length=255)),
                ('identifierType', models.CharField(db_column='identifier_type', db_index=True, max_length=20)),
                ('uniprotID', models.CharField(db_column='uniprot_id', db_index=True, max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interface_area_hydrophilic', models.FloatField(blank=True, null=True)),
                ('interface_area_total', models.FloatField(blank=True, null=True)),
                ('domain1', models.ForeignKey(db_column='domain_id_1', on_delete=django.db.models.deletion.CASCADE, related_name='p1', to='web_pipeline.coremodellocal')),
                ('domain2', models.ForeignKey(db_column='domain_id_2', on_delete=django.db.models.deletion.CASCADE, related_name='p2', to='web_pipeline.coremodellocal')),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affectedType', models.CharField(blank=True, choices=[('NO', 'None'), ('CO', 'Core'), ('IN', 'Interaction')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_pipeline.job')),
                ('mut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_pipeline.mut')),
            ],
            options={
                'db_table': 'job_to_mut',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provean_score', models.FloatField(blank=True, null=True)),
                ('ddG', models.FloatField(blank=True, db_column='ddg', null=True)),
                ('model', models.ForeignKey(db_column='domain_id', on_delete=django.db.models.deletion.CASCADE, related_name='muts', to='web_pipeline.coremodellocal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provean_score', models.FloatField(blank=True, null=True)),
                ('ddG', models.FloatField(blank=True, db_column='ddg', null=True)),
                ('model', models.ForeignKey(db_column='interface_id', on_delete=django.db.models.deletion.CASCADE, related_name='muts', to='web_pipeline.interfacemodellocal')),
                ('elaspic_version', models.CharField(max_length=255, null=True)),
            ],
            options={
                'abstract': False,
